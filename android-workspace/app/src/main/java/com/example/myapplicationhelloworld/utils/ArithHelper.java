...
public class ArithHelper {
    ...
    public static double sqrt(String v1,String v2) {
        double str = Math.pow((Double.valueOf(v2)),(1/Double.valueOf(v1)));
        return str;
    }
    ...
    public static double tan(String v) {
        Double str = Double.valueOf(v);
        double a = 0;
        a = Math.round(Math.tan(str*Math.PI/180)*100);
        return a/100;
    }
    ...
    public static double cube(String v) {
        double str = Double.valueOf(v);
        return str * str * str;
    }

    public static double power(String v1,String v2) {
        double str = Math.pow(Double.valueOf(v1),Double.valueOf(v2));
        return str;
    }
}